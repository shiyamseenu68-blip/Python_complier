...
**Note:** Python code execution is not available on Vercel deployments. The app will show a message indicating this limitation. For full Python execution, run locally with `npm run dev`.
