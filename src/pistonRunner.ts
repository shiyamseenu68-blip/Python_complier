/**
 * pistonRunner.ts — Python execution using Piston API
 * 
 * Piston is a free API for code execution that doesn't require authentication.
 * Works on Vercel without any CDN loading issues.
 */
